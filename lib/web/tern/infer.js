...
(function(root, mod) {
  ...
  mod(root.tern || (root.tern = {}), self.acorn, self.acorn, self.acorn.walk, self.tern.def, self.tern.signal); // Plain browser env
})(self, function(exports, acorn, acorn_loose, walk, def, signal) {
  "use strict";
