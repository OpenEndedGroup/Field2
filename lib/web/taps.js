globalCommands.push({
    ...
    "callback": function () {
        insertTapHere("default", 14, 14, generateUUID());
    }
});

globalCommands.push({
    "name": "Insert Red",
    "info": "Inserts a red <i>'pad'</i> into this code",
    "callback": function () {
        insertTapHere("PAD", 14, 14, "RED");
    }
});
...
globalCommands.push({
    ...
    "callback": function () {
        insertTapHere("exec", 14, 14, generateUUID());
    }
});

insertTap = function (selection_start, selection_end, uid, w, h) {

    canvas = newMarkingCanvas(selection_start, selection_end, w, h, true);
...
insertTapHere = function (ty, w, h, UID) {
