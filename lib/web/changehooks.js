...
var serializeAllFolds= {getState: function() {
        var $$ = window,
            doc = $$.cm.getDoc(),
...
fireChange = debounce(function(cm)
{
    if (cm.currentbox && cm.currentproperty) {
        ...
        cookie.folds = serializeAllFolds.getState();
...
_messageBus.subscribe("selection.changed", function (d, e) {
    ...
    if (d.cookie) {
        ...
        if (d.cookie.output) {
            try {
                ...
                console.log(" trouble in cookie output eval bracket...")
                console.log(e);
            }
        ...
        if (d.cookie.brackets) {
            ...
            try {
                ...
                console.log(" trouble in cookie eval bracket...")
                console.log(e);
            }
        ...
        if (d.cookie.folds)
        {
            serializeAllFolds.setState(d.cookie.folds)
        }
    }
    ...
    if (!d.box) {
        ...
        console.log(" language name is " + d.languageName)
