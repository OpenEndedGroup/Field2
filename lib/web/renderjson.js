...
(module||{}).exports = renderjson = (function() {
    ...
    var isempty = function(obj) { for (var k in obj) if (obj.hasOwnProperty(k)) return false;
                                  return true; }
    var stripQuotes = function(txt) { if (txt.startsWith("\"") && txt.endsWith("\"")) return txt.substring(1, txt.length-1); else return txt;}
    var text = function(txt) { return document.createTextNode(stripQuotes(txt)) };
