...
_messageBus.subscribe("box.error", function (d, e) {
    ...
    if (cm.currentbox === box) {
        if (d.line != undefined)
            appendRemoteOutputToLine(d.line - 1, d.message, "Field-remoteOutput", "Field-remoteOutput-error", false)
        else
            appendRemoteOutputToLine(cm.lineCount() - 1, d.message, "Field-remoteOutput", "Field-remoteOutput-error", false)
