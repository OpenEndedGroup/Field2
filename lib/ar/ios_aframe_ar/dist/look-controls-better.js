...
// var KEYCODE_TO_CODE = AFRAME.keyboardevent.KEYCODE_TO_CODE;
 ...
 */
registerComponent('wasd-controls-better', {
    schema: {
    ...
    updateVelocity: function (delta) {
        ...
        if (data.qzEnabled) {
            if (keys.KeyQ ) { velocity[qzAxis] -= 1 * acceleration * delta; }
            if (keys.KeyZ ) { velocity[qzAxis] += 1 * acceleration * delta; }
        }
    },
