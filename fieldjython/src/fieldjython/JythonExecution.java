...
public class JythonExecution extends Execution {
	static public final Dict.Prop<Boolean> bridgedToJython = new Dict.Prop<>("bridgedToClojure").toCannon();
	...
	public JythonExecution()
	{
		...
		PythonInterpreter.initialize(null, null, new String[]{});
...
*/
	...
	protected Object eval(Writer output, String textFragment, Consumer<Pair<Integer, String>> lineErrors) {
		try {
			PyObject res = py.eval(textFragment);

			return res == null ? null : res.__tojava__(Object.class);
		}
		catch(Exception e)
		{
			e.printStackTrace();
