...
public interface CefRunFileDialogCallback {
	...
	/**
	 * Called asynchronously after the file dialog is dismissed. If the selection was successful file_paths will be a single value or a list of
	 * values depending on the dialog mode. If the selection was cancelled file_paths will be empty.
	 *
