...
public interface CefFocusHandler {
	...
	/**
	 * Called when the browser component is about to loose focus. For instance, if focus was on the last HTML element and the user pressed the TAB
	 * key.
	 *
	 * @param browser The browser generating the event.
	 * @param next    will be true if the browser is giving focus to the next component and false if the browser is giving focus to the previous
	 *                component.
	 */
