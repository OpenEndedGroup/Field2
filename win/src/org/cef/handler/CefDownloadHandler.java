...
public interface CefDownloadHandler {
	/**
	 * Called before a download begins. By default the download will be canceled. Execute callback either asynchronously or in this method to
	 * continue the download if desired.
	 *
