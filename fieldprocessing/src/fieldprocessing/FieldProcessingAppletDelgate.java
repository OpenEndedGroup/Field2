...
//  static public final int STROKED_SHAPE     = 61;
	 ...
	 * physics, perlin noise is computed over several octaves which are added together for the final result. <br /><br />Another way to adjust the
	 ...
	 * <p>
	 * <B>The options shown here are not yet finalized and will be changing over the next several releases.</B>
	 * <p>
	 ...
	 * based on the current <b>textDescent()</b>. For multiple lines, the final line will be aligned to the bottom, with the previous lines
