...
public class Drawing extends Box {
    ...
    static public final Dict.Prop<FunctionOfBox<Boolean>> repaint = new Dict.Prop<>("repaint").type().toCannon().doc("call `_.repaint()` to redraw the canvas (at some point in the future)");
    ...
    public Drawing() {
        ...
        this.properties.put(repaint, x -> {dirty(x); return true;});
