...
public class GeolocationHandler extends CefGeolocationHandlerAdapter {
	...
	public void onRequestGeolocationPermission(CefBrowser browser, String requesting_url, int request_id, CefGeolocationCallback callback) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			@Override
			public void run() {
				int dialogResult = JOptionPane.showConfirmDialog(owner_, "The URL \n" + reqUrl +
							"\nwants to request your geolocation." +
							"\nDo you want to proceed?", "Geolocation requested", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
