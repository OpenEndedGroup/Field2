...
public interface CefKeyboardHandler {
	...
	public static final class CefKeyEvent {
		...
		/**
		 * The Windows key code for the key event. This value is used by the DOM specification. Sometimes it comes directly from the event
		 * (i.e. on Windows) and sometimes it's determined using a mapping function. See WebCore/platform/chromium/KeyboardCodes.h for the
		 * list of values.
		 */
		 ...
		 * for details). This value will always be false on non-Windows platforms.
		 */
		...
		/**
		 * True if the focus is currently on an editable field on the page. This is useful for determining if standard key events should be
		 * intercepted.
		 */
