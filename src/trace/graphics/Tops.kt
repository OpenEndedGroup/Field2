    ...
    fun synchronizeUniformsAndDeclarations(root: Box) {
        ...
        root.forEach {
            ...
            if (a != null && a is Boolean && a) {
                ...
                if (fbo is FBO && shader is Shader) namesSoFar.put(name, fbo to shader)
            }
        }
        ...
        root.forEach {
            ...
            var a = it.properties.get(Dict.Prop<Any>("textureOperator"))
            var ni = it.properties.get(Dict.Prop<Any>("textureOperator_noInputs"))
            ...
            if (a != null && a is Boolean && a) {
                ...
                val previous = root.properties.get(Dict.Prop<String>("_uniform_decl_"))
                if (u != previous) {
                    it.properties.put(Dict.Prop<String>("_uniform_decl_"), u)

                    println(" \n\n\n shader inside $name needs reloading, will do this automatically eventually \n\n\n")
                }
