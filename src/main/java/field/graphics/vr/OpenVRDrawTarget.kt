...
class OpenVRDrawTarget {
    ...
    fun init(w: Scene) {
        ...
        w.attach(100, "__go_openvr__") { _: Int ->
            ...
            if (fbo != null && true) stackPush().use {
...
//                val a = ByteBuffer.allocateDirect(8).order(ByteOrder.nativeOrder()).asLongBuffer()
//                a.clear()
//                VRInput.VRInput_GetActionHandle("/user/hand/left/output/haptic", a)
//                VRInput.VRInput_TriggerHapticVibrationAction(a.get(0), 0f, 1f, 100f, 100f, 0)
...
//                            println("left hand")
//                            if (Math.random() < 0.5) {
//                                println(" haptic pulse !")
//                                VRSystem_TriggerHapticPulse(n, 1, (1000000/90).toShort())
//                            }
                            ...
                            for (q in 0 until 63) {
                                ...
                                if ((td and (1L shl q)) != 0L) leftTouched.add("button${q}_left")
                            }
                        } else {
//                            println("right hand")
...
//                            if (Math.random() < 0.01) {
//                                println(" haptic pulse !")
//                                VRSystem_TriggerHapticPulse(n, 1, (1000 * 100).toShort())
//                            }
                            if (!lockHead) {
                                hand2.set(
                                        h34.m(0),
                            ...
                            for (q in 0 until 63) {
                                ...
                                if ((td and (1L shl q)) != 0L) rightTouched.add("button${q}_right")
                            }
                        }
