...
public class IsExecuting extends Box {
    ...
    static public final Dict.Prop<Integer> executionSequenceCount = new Dict.Prop<>("_executionSequenceCount").type().toCanon().doc("How many times has this box been .begin() without launching?");
