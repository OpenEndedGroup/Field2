...
import fieldbox.boxes.Mouse.OnMouseMove
import fieldbox.boxes.Mouse.OnMouseScroll
import fieldbox.boxes.Box.BiFunctionOfBoxAnd
...
import fieldbox.boxes.Keyboard.OnCharTyped
...
//		});
    ...
    override fun loaded() {
        ...
        val rsf = 2//window!!.getRetinaScaleFactor();
