 ...
 *
 * indebted to Michael Patrick Johnson <aries@media.mit.edu>, although any
...
public class BaseMath {
	...
	static public Vec3 circumcenterOf(Vec3 A, Vec3 B, Vec3 C) {
		...
		if (A.z == 0.0 && B.z == 0.0 && C.z == 0.0) {
			...
			Vec3.add(BmA, (float) s, A, r);
			Vec3.add(CmA, (float) t, r, r);
		}
		return r;
	}
	...
	static public Vec2 circumcenterOf(Vec2 A, Vec2 B, Vec2 C) {
		...
		Vec2.add(BmA, (float) s, A, r);
		Vec2.add(CmA, (float) t, r, r);
