...
public class Mat3 implements Serializable {
	...
	/**
	 * Load from a float buffer. The buffer stores the Mat3 in column major
	 * (OpenGL) order.
	 *
	...
	/**
	 * Load from a float buffer. The buffer stores the Mat3 in row major
	 * (maths) order.
	 *
	 * @param buf A float buffer to read from
	 * @return this
	 */
	public Mat3 loadTranspose(FloatBuffer buf) {
	...
	/**
	 * Store this Mat3 in a float buffer. The Mat3 is stored in column
	 * major (openGL) order.
	 *
	...
	/**
	 * Store this Mat3 in a float buffer. The Mat3 is stored in row
	 * major (maths) order.
	 *
	 * @param buf The buffer to store this Mat3 in
	 */
	public Mat3 storeTranspose(FloatBuffer buf) {
		buf.put(m00);
		buf.put(m10);
		buf.put(m20);
		buf.put(m01);
	...
	public boolean equals(Object o) {
		...
		if (Float.compare(mat3.m22, m22) != 0) return false;
