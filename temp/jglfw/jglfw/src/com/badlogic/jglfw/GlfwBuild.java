...
public class GlfwBuild {
	...
	public static void main(String[] args) throws Exception {
		...
		win32.cIncludes = merge(commonSrc,
			...
			"glfw-3.0/src/win32_tls.c",
			"glfw-3.0/src/winmm_joystick.c",
		...
		linux32.cIncludes = merge(commonSrc,
			...
			"glfw-3.0/src/posix_tls.c",
			"glfw-3.0/src/posix_time.c",
			"glfw-3.0/src/linux_joystick.c",
		...
		linux32.libraries = "-lX11 -lXrandr -lXi -lXcursor -lXxf86vm -lpthread";
