...
public static final int GLFW_DISCONNECTED           =0x00040002;
	...
	*/
	...
	public static native long glfwCreateCursor(ByteBuffer image, int width, int height, int xhot, int yhot); /*
	const GLFWimage im = {width, height, (unsigned char*)image};
	return (jlong) glfwCreateCursor(&im, xhot, yhot);
	 */
	
	public static native void glfwSetCursor(long window, long cursor); /*
